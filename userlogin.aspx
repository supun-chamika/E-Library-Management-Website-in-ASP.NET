                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img src="img/generaluser.png" width="130px" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <asp:TextBox runat="server" class="form-control" placeholder="Member Id" ID="TextBox1"></asp:TextBox>
                                </div>
                                    ...
                                    <div class="d-grid gap-2">
                                        ...
                                        <div class="form-group">
                                            <a href="usersignup.aspx">
                                                <input class="btn btn-info btn-block btn-lg button-w" id="Button2" type="button" value="Sign Up" />
                                            </a>
                                        </div>
                                    </div>
                                </center>
